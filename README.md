...
Refactor windows forms single form c# app to MVC style using observer not event
.NET 5 c# winforms desktop app

-please edit to APA style - still learning how to reference as I never have needed to before (kinda strange always writing from scratch - unusal these days),
  except for one instance when I build an app entirely from many different pieces of example code, and then used this book (see below) to learn to make it something entirely different.
